  ...
  [23],
  {
    ...
    5751: function (e, t, n) {
      ...
      function D(e) {
        ...
        let { pushRef: $ } = (0, s.useUnwrapState)(I);
        if ($.mpaNavigation) {
          if (w.pendingMpaPath !== F) {
            let e = window.location;
            ($.pendingPush ? e.assign(F) : e.replace(F),
              (w.pendingMpaPath = F));
          }
    ...
    4549: function (e, t, n) {
      ...
      let r = n(4590),
        ...
        h = n(774),
        y = n(4922),
        { createFromFetch: _, encodeReply: v } = n(3235);
    ...
    2441: function (e, t, n) {
      ...
      let o = (r = n(1196)) && r.__esModule ? r : { default: r },
        u = n(7910),
        l = n(5108),
        a = n(1358),
        ...
        if (!e.isUnstableCacheCallback) {
          ...
          if (e.prerenderState) h(e.prerenderState, t, n);
            ...
            let r = new u.DynamicServerError(
              "Route "
                .concat(n, " couldn't be rendered statically because it used ")
                .concat(
                  t,
        ...
        if (e.isUnstableCacheCallback)
          throw Error(
            "Route "
              ...
              .concat(
                t,
                '" inside a function cached with "unstable_cache(...)". Accessing Dynamic data sources inside a cache scope is not supported. If you need this data inside a cached function use "',
              )
              .concat(
                t,
                '" outside of the cached function and pass the required dynamic data in as an argument. See more info here: https://nextjs.org/docs/app/api-reference/functions/unstable_cache',
              ),
          );
        if (e.dynamicShouldError)
          throw new l.StaticGenBailoutError(
      ...
      function d(e) {
        let { reason: t, prerenderState: n, pathname: r } = e;
        h(n, t, r);
      }
      function p(e, t) {
    ...
    6590: function (e, t, n) {
      ...
      let r = n(9920)._(n(1196)).default.createContext({});
    },
    8056: function (e, t, n) {
      "use strict";
      (Object.defineProperty(t, "__esModule", { value: !0 }),
